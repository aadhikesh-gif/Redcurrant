...
exports.commands = {
	...
	playalpha: function (target, room, user, connection, cmd) {
		...
		if (cmd === 'playalpha') {
			...
			// New Game
			user.console.queue = ["text|Welcome to the world of Pokemon!<br/>I'm FrostieNana, the owner of this server. (Click the star to continue)",
