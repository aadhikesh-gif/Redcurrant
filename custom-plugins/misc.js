...
exports.commands = {
	...
	credits: function (target, room, user) {
		let popup = "|html|" + "<font size=5 color=#0066ff><u>" + serverName + " Credits</b></u></font><br />" +
			...
			"- " + Server.nameColor('FrostieNana', true) + " (Owner, System Operator, Policy Admin, Development)<br />" +
      "- " + Server.nameColor('Shade Zeraninja', true) + " (System Operator, Policy Admin, Development)<br />" +
			"<br />" +
			"<u><b>Contributors:</b></u><br />" +
			"- " + Server.nameColor('Tapu J0J0', true) + " (System Operator, SGGame Owner, Mega Stones Manager)<br />" +
			"- " + Server.nameColor('Shade Ritik', true) + " (Server Admin, Community Admin, Guild Staff)<br />" +
			"- " + Server.nameColor('Swift Eevee', true) + " (Leagues Staff, Global Admin)<br />"+
		...
		/*"<u><b>Contributors:</b></u><br />" +
			...
			"- " + Server.nameColor('Aadhikesh', true) + " (Former Owner, System Operator, Development)<br />" +
			"<br />" +
