...
function save() {
	if (Object.keys(leagues).length < 1) return Server.writeFileSync('config/leagues.json', JSON.stringify(leagues));
	let data = "{\n";
...
fs.getLeagueRank = getLeagueRank;
...
fs.leagueTourPoints = leagueTourPoints;
