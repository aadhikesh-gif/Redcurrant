			...
			EXP.writeExp(user.userid, amount, newTotal => {
				...
				if (oldLevel < level) {
					...
					case 40:
						...
						reward = `a Profile Music. To claim your profile music, use the command /usetoken music, [song url], [title of the song] respectively.`;
						break;
          case 30:
		...
		if (target || !target && this.broadcasting) {
			...
			EXP.readExp(user.userid, exp => {
				this.sendReplyBox(
					...
					"Level 40 unlocks a free Profile Music. <br /><br />" +
					"Level 45 unlocks a free Chatroom.<br /><br />"+
          "Level 50 unlocks a free Room Shop.<br /><br />"
				);
			});
		}
	},
